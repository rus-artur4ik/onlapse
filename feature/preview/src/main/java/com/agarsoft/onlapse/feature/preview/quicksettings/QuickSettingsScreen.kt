 ...
 */
package com.agarsoft.onlapse.feature.preview.quicksettings
...
import com.agarsoft.onlapse.feature.preview.CaptureModeToggleUiState
import com.agarsoft.onlapse.feature.preview.DEFAULT_CAPTURE_BUTTON_STATE
import com.agarsoft.onlapse.feature.preview.FlashModeUiState
import com.agarsoft.onlapse.feature.preview.PreviewMode
import com.agarsoft.onlapse.feature.preview.PreviewUiState
import com.agarsoft.onlapse.feature.preview.R
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.FocusedQuickSetRatio
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QUICK_SETTINGS_CONCURRENT_CAMERA_MODE_BUTTON
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QUICK_SETTINGS_FLASH_BUTTON
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QUICK_SETTINGS_FLIP_CAMERA_BUTTON
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QUICK_SETTINGS_HDR_BUTTON
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QUICK_SETTINGS_RATIO_BUTTON
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QUICK_SETTINGS_STREAM_CONFIG_BUTTON
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QuickFlipCamera
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QuickSetConcurrentCamera
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QuickSetFlash
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QuickSetHdr
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QuickSetRatio
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QuickSetStreamConfig
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QuickSetTimelapseFrequencyConfig
import com.agarsoft.onlapse.feature.preview.quicksettings.ui.QuickSettingsGrid
...
private fun ExpandedQuickSettingsUi(
    ...
    Column(
        ...
        AnimatedVisibility(visible = focusedQuickSetting == FocusedQuickSetting.NONE) {
            ...
            QuickSettingsGrid(
                quickSettingsButtons = displayedQuickSettings
            )
        }
