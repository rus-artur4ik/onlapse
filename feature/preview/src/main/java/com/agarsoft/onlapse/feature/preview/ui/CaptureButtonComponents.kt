 ...
 */
package com.agarsoft.onlapse.feature.preview.ui
...
fun CaptureButton(
    ...
    captureButtonUiState: com.agarsoft.onlapse.feature.preview.CaptureButtonUiState,
    ...
    LaunchedEffect(captureButtonUiState) {
        if (captureButtonUiState is com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.Idle) {
    ...
    fun onKeyUp(captureSource: CaptureSource) {
        ...
        if (firstKeyPressed.value == captureSource) {
            when (currentUiState.value) {
                is com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.Idle -> onImageCapture()

                com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.RecordingTimelapse,
                com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Unavailable -> {
                }
            }
...
private fun CaptureButtonNucleus(
    ...
    val centerShapeSize by animateDpAsState(
        targetValue = when (currentUiState.value) {
            ...
            com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Unavailable -> 0.dp
            is com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.Idle -> (captureButtonSize * idleImageCaptureScale).dp
        },
    ...
    val animatedColor by animateColorAsState(
        targetValue = when (currentUiState.value) {
            is com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.Idle -> imageCaptureModeColor

            is com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.RecordingTimelapse -> recordingColor
            is com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Unavailable -> Color.Transparent
        },
        ...
        Box(modifier = Modifier) {
            Box(
                ...
                modifier = Modifier
                    ...
                    .alpha(
                        if (isPressed &&
                            currentUiState.value == com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.Idle
                        ) {
...
private fun IdleStandardCaptureButtonPreview() {
    CaptureButtonRing(captureButtonSize = DEFAULT_CAPTURE_BUTTON_SIZE, color = Color.White) {
        CaptureButtonNucleus(
            captureButtonUiState = com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.Idle,
            isPressed = false,
...
private fun IdleImageCaptureButtonPreview() {
    CaptureButtonRing(captureButtonSize = DEFAULT_CAPTURE_BUTTON_SIZE, color = Color.White) {
        CaptureButtonNucleus(
            captureButtonUiState = com.agarsoft.onlapse.feature.preview.CaptureButtonUiState.Enabled.RecordingTimelapse,
            isPressed = false,
            captureButtonSize = DEFAULT_CAPTURE_BUTTON_SIZE
        )
    }
