    ...
    when (val currentUiState = previewUiState) {
        ...
        is PreviewUiState.Ready -> {
            ...
            ContentScreen(
                ...
                onSetTimelapseFrequencyConfig = viewModel::setTimelapseFrequencyConfig,
...
private fun LoadingScreen(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(text = stringResource(com.agarsoft.onlapse.feature.preview.R.string.camera_not_ready), color = Color.White)
    }
}
