...
import com.agarsoft.onlapse.settings.model.VideoQuality.FHD
import com.agarsoft.onlapse.settings.model.VideoQuality.HD
import com.agarsoft.onlapse.settings.model.VideoQuality.SD
import com.agarsoft.onlapse.settings.model.VideoQuality.UHD
import com.agarsoft.onlapse.settings.model.VideoQuality.UNSPECIFIED
...
fun DynamicRange.toCXDynamicRange(): CXDynamicRange {
    return when (this) {
        com.agarsoft.onlapse.settings.model.DynamicRange.SDR -> CXDynamicRange.SDR
        com.agarsoft.onlapse.settings.model.DynamicRange.HLG10 -> CXDynamicRange.HLG_10_BIT
    }
}
